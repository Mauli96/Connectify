    ...
    Box(
        ...
        Column(
            ...
            StandardTextField(
                ...
                onValueChange = { viewModel.onEvent(RegisterEvent.OnEnteredEmail(it)) },
                keyboardType = KeyboardType.Email,
                imeAction = ImeAction.Next,
                onNext = { focusManager.moveFocus(FocusDirection.Down) },
                leadingIcon = painterResource(id = R.drawable.ic_email),
                error = when (emailState.error) {
                    is AuthError.FieldEmpty -> stringResource(R.string.this_field_cant_be_empty)
                    is AuthError.InvalidEmail -> stringResource(R.string.not_a_valid_email)
                    else -> ""
                },
            ...
            StandardTextField(
                ...
                onValueChange = { viewModel.onEvent(RegisterEvent.OnEnteredUsername(it)) },
                imeAction = ImeAction.Next,
                onNext = { focusManager.moveFocus(FocusDirection.Down) },
                error = when (usernameState.error) {
                    is AuthError.FieldEmpty -> stringResource(R.string.this_field_cant_be_empty)
                    is AuthError.InputTooShort -> stringResource(R.string.input_too_short, Constants.MIN_USERNAME_LENGTH)
                    else -> ""
                },
            ...
            StandardTextField(
                ...
                onValueChange = { viewModel.onEvent(RegisterEvent.OnEnteredPassword(it)) },
                ...
                error = when (passwordState.error) {
                    is AuthError.FieldEmpty -> stringResource(R.string.this_field_cant_be_empty)
                    is AuthError.InputTooShort -> stringResource(R.string.input_too_short, Constants.MIN_PASSWORD_LENGTH)
                    is AuthError.InvalidPassword -> stringResource(R.string.invalid_password)
                    else -> ""
                },
